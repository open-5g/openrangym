...
### NVIDIA Aerial
The NVIDIA Aerial information and installation guide is available at [this website](https://docs.nvidia.com/aerial/cuda-accelerated-ran/index.html).
...
### xApp
A basic xApp developed in Python and easily extendable can be found at [this GitHub repository](https://github.com/wineslab/xapp-oai/tree/kpm-xapp). This repository contains a few Python examples that can subscribe to selected RAN parameters, receive periodic indication messages, and send control requests to update these parameters.
