...
The E2 agent is based on the OSC e2sim project. An OAI version with the custom E2 Agent already integrated in the 2024w18 can be found at [this GitHub repository](https://github.com/wineslab/x5g-openairinterface/tree/2024w18_e2agent).
