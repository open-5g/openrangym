...
```
This script is a watchdog that monitors the output files of the ns3 simulation within the directory. The data generated by ns3 is analyzed and sent via Telegraf to InfluxDB, from which Grafana extracts the data for visualization. 
...
Four dashboard are available to be displayed:
